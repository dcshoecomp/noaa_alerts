...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend({
    ...
    vol.Optional(CONF_SCAN_INTERVAL, default=DEFAULT_INTERVAL): vol.All(cv.time_period, cv.positive_timedelta),
})
...
def setup_platform(hass, config, add_entities, discovery_info=None):
    ...
    update_interval = config.get(CONF_SCAN_INTERVAL, DEFAULT_INTERVAL)
    add_entities([noaa_alertsSensor(zoneid, event_urgency,
                                    event_severity, latitude, longitude, update_interval)], True)
